...
class AgenticTrainingController(nn.Module):
    ...
    def format_step(
        ...
        return (
            ...
            f"label_p/a/m/f={_metric(losses, 'metric_arf_planned_label_precision'):.3f}/"
            f"{_metric(losses, 'metric_arf_actual_label_precision'):.3f}/"
            f"{_metric(losses, 'metric_arf_missed_only_label_precision'):.3f}/"
            f"{_metric(losses, 'metric_arf_actual_only_false_label_precision'):.3f} "
            f"depth_a5/10/20={_metric(losses, 'metric_arf_actual_label_precision_at5'):.3f}/"
            f"{_metric(losses, 'metric_arf_actual_label_precision_at10'):.3f}/"
            f"{_metric(losses, 'metric_arf_actual_label_precision_at20'):.3f} "
            f"depth_f5/10/20={_metric(losses, 'metric_arf_actual_only_false_label_precision_at5'):.3f}/"
            f"{_metric(losses, 'metric_arf_actual_only_false_label_precision_at10'):.3f}/"
            f"{_metric(losses, 'metric_arf_actual_only_false_label_precision_at20'):.3f} "
            f"score_med/h/l={_metric(losses, 'metric_arf_actual_only_planner_score_median'):.3f}/"
            f"{_metric(losses, 'metric_arf_actual_only_high_score_label_precision'):.3f}/"
            f"{_metric(losses, 'metric_arf_actual_only_low_score_label_precision'):.3f} "
            ...
            f"candidates={_metric(losses, 'metric_agentic_memory_candidate_count'):.0f} "
            f"candidate_scale={_metric(losses, 'metric_agentic_memory_candidate_scale', 1.0):.2f} "
            f"source_scale={_metric(losses, 'metric_agentic_memory_source_scale', 1.0):.2f} "
            ...
            f"logits(batch={_metric(losses, 'metric_agentic_batch_logit_mean'):.3f}/"
            f"{_metric(losses, 'metric_agentic_batch_logit_std'):.3f}/"
            f"{_metric(losses, 'metric_agentic_batch_logit_min'):.3f}/"
            f"{_metric(losses, 'metric_agentic_batch_logit_max'):.3f} "
            f"memory={_metric(losses, 'metric_agentic_memory_logit_mean'):.3f}/"
            f"{_metric(losses, 'metric_agentic_memory_logit_std'):.3f}/"
            f"{_metric(losses, 'metric_agentic_memory_logit_min'):.3f}/"
            f"{_metric(losses, 'metric_agentic_memory_logit_max'):.3f} "
            f"denom_ratio={_metric(losses, 'metric_agentic_memory_denom_mass_ratio'):.2e} "
            f"denom_gap={_metric(losses, 'metric_agentic_memory_denom_log_mass_gap'):.3f} "
            f"positive_gap={_metric(losses, 'metric_agentic_memory_positive_logit_gap'):.3f}) "
    ...
    def format_epoch(self, epoch: int, stats: Dict[str, float]) -> str:
        return (
            ...
            f"label_p/a/m/f={stats.get('metric_arf_planned_label_precision', 0.0):.3f}/"
            f"{stats.get('metric_arf_actual_label_precision', 0.0):.3f}/"
            f"{stats.get('metric_arf_missed_only_label_precision', 0.0):.3f}/"
            f"{stats.get('metric_arf_actual_only_false_label_precision', 0.0):.3f} "
            f"depth_a5/10/20={stats.get('metric_arf_actual_label_precision_at5', 0.0):.3f}/"
            f"{stats.get('metric_arf_actual_label_precision_at10', 0.0):.3f}/"
            f"{stats.get('metric_arf_actual_label_precision_at20', 0.0):.3f} "
            f"depth_f5/10/20={stats.get('metric_arf_actual_only_false_label_precision_at5', 0.0):.3f}/"
            f"{stats.get('metric_arf_actual_only_false_label_precision_at10', 0.0):.3f}/"
            f"{stats.get('metric_arf_actual_only_false_label_precision_at20', 0.0):.3f} "
            f"score_med/h/l={stats.get('metric_arf_actual_only_planner_score_median', 0.0):.3f}/"
            f"{stats.get('metric_arf_actual_only_high_score_label_precision', 0.0):.3f}/"
            f"{stats.get('metric_arf_actual_only_low_score_label_precision', 0.0):.3f} "
            ...
            f"memory(candidates={stats.get('metric_agentic_memory_candidate_count', 0.0):.0f} "
            f"candidate_scale={stats.get('metric_agentic_memory_candidate_scale', 1.0):.2f} "
            f"source_scale={stats.get('metric_agentic_memory_source_scale', 1.0):.2f} "
            f"edge_p={stats.get('memory_edge_posterior', 0.0):.3f} "
            ...
            f"logits(batch={stats.get('metric_agentic_batch_logit_mean', 0.0):.3f}/"
            f"{stats.get('metric_agentic_batch_logit_std', 0.0):.3f}/"
            f"{stats.get('metric_agentic_batch_logit_min', 0.0):.3f}/"
            f"{stats.get('metric_agentic_batch_logit_max', 0.0):.3f} "
            f"memory={stats.get('metric_agentic_memory_logit_mean', 0.0):.3f}/"
            f"{stats.get('metric_agentic_memory_logit_std', 0.0):.3f}/"
            f"{stats.get('metric_agentic_memory_logit_min', 0.0):.3f}/"
            f"{stats.get('metric_agentic_memory_logit_max', 0.0):.3f} "
            f"denom_ratio={stats.get('metric_agentic_memory_denom_mass_ratio', 0.0):.2e} "
            f"denom_gap={stats.get('metric_agentic_memory_denom_log_mass_gap', 0.0):.3f} "
            f"positive_gap={stats.get('metric_agentic_memory_positive_logit_gap', 0.0):.3f}) "
